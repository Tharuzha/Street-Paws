...
<body>
	...
	<form action="loginprocess.php" method="POST">
		<div style="font-family:'Copperplate', 'Copperplate Gothic Light'; font-size: 40px">Register as an Admin</div>
        ...
        <div>
			<br>
        <a href="../login.php" style="color:brown; font-family:'Copperplate', 'Copperplate Gothic Light'">Login as an User</a>
</div>
		</form>
		<?php	
